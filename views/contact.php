	...
	function show()
	{
		...
		<div class="col-md-12">
			...
			<div class="attachment">
				<!--<iframe src="https://www.google.com/maps/d/embed?Dhp2Jkq3jUkTKuYg9" width="100%" height="400"></iframe>-->
		...
		<p>Phone: 07340955516</p>
		<p><strong><a href="mailto:gustavfn@yahoo.co.uk">Send us an email</a></strong></p>
		...
		<div>
			...
			<div class="widget widget-facebook-news">
				<div class="fb-page" data-height="800" data-href="https://www.facebook.com/NoLimitSouljaMedia" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
					<blockquote cite="https://www.facebook.com/ethim.antwerpen" class="fb-xfbml-parse-ignore">
						<a href="https://www.facebook.com/NoLimitSouljaMedia">Facebook</a>
					</blockquote>
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div class="widget" id="twitter-news">
				<a class="twitter-timeline" data-width="265" data-height="800" href="https://twitter.com/nolimitmedia">Tweets by Nolimit Media</a>
