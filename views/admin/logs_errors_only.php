...
class logs_errors_only extends \Dorguzen\Core\DGZ_AdminHtmlView
{
                         ...
                         <div class="container">
                              ...
                              <div class="row">
                                   <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                                        <h1 style="color:#000;" class="mb-0">Runtime Error Logs</h1>
                                        <?php if ($totalCount > 0) { ?>
                                   ...
                                   <?php if ($numPages > 1) {
                                        $baseUrl = $this->controller->config->getFileRootPath() . 'admin/log-errors-only'; ?>
