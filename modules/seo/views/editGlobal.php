						...
						<div class="col-sm-12 col-lg-12">
							...
							{ ?>
                                ...
                                <div class="panel panel-primary">
									...
									<?php
									$form::open('editShop', $this->controller->config->getFileRootPath().'seo/saveGlobalEdit', 'post'); ?>
										<div class="panel-body panel-primary">
											<div class="container bg-light p-2">
												<fieldset>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_geo_placename', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_geo_placename'] ?? ' ']); 
														?>
													</div>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_geo_region', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_geo_region'] ?? ' ']); 
														?>
													</div>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_geo_position', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_geo_position'] ?? ' ']); 
														?>
													</div>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_reflang_alternate1', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_reflang_alternate1'] ?? ' ']); 
														?>
													</div>
													...
													<span class="font-weight-bold section-title">Alternate Reflangs. This section is for URL links for applications that have multiple
									                    ...
									                    $form::input('seo_global_reflang_alternate2', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_reflang_alternate2'] ?? ' ']); 
														?>
													</div>
												</fieldset>	
												...
												<fieldset>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_og_locale', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_og_locale'] ?? ' ']);
														?>
													</div>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_og_site', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_og_site'] ?? ' ']); 
														?>
													</div>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_og_article_publisher', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_og_article_publisher'] ?? ' ']); 
														?>
													</div>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_og_author', 'textarea', ['class' => 'form-control'], $globalData['seo_global_og_author'] ?? ' '); 
														?>
													</div>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_fb_id', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_fb_id'] ?? ' ']); 
														?>
													</div>
												</fieldset>	
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_twitter_card', 'text', ['class' => 'form-control', 'value' => $globalData['seo_global_twitter_card'] ?? ' ']); 
														?>
													</div>
													...
													<div class="col-sm-12 col-md-12 col-lg-12 form-group">
									                    ...
									                    $form::input('seo_global_twitter_site', 'textarea', ['class' => 'form-control'], $globalData['seo_global_twitter_site'] ?? ' '); 
														?>
														</div>
							                    </fieldset>
												</div>
											...
											<div class="panel-footer">
											    <div class="form-group">
													<?php
													$form::hidden('seo_global_id', $globalData['seo_global_id']);
