                ...
                <div class="col-sm-3 col-xs-6">
                	<div class="footer-widget footer-widget-contacts">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="fa fa-envelope"></i> yourEmail@example.com</li>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="footer-widget footer-widget-twitter">
                        ...
                        <div id="twitter-wrapper">
                            ...
                            <a class="twitter-timeline" data-width="265" data-height="250" href="https://twitter.com/">Tweets by someone</a>
                            <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
                            <!-- WIDGET: FACEBOOK NEWS - END -->
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6 footer-widget footer-widget-facebook">
            ...
            <div class="footer-bottom">
            	<div class="row">
                    <div class="col-sm-6">
                        ...
                        <p class="copyright">Designed by <a href="http://www.nolimitmedia.co.uk" target="_blank">Nolimit Media Ltd</a>
                        </p>
                    </div>
                    <div class="col-sm-6">
