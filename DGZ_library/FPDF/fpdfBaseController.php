...
class fpdfBaseController
{
	...
	function Output($name='', $dest='')
	{
		...
		//Once the PDF could only be created if i placed die() here at the end of the Output() meth. Returning a blank string made it produce a blank PDF
		//though it worked with the old training diary-but maybe its coz the old app runs on dev3 n the new one on dev4 (diff PHP versions)

		//Also, in order for this to work, the class including (extending) this one had to have a constructor that called this class's FPDF() meth
		// e.g.
	...
	function _dochecks()
	{
		...
		//TODO: I have removed these two lines as they are deprecated
